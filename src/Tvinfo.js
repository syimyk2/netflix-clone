...
import SimilarListsOfTv from "./similartv/SimilarListsOfTv";
  ...
  render() {
    ...
    const content =
      Object.keys(movie).length > 0 ? (
        ...
        >
          ...
          <div className="content">
            ...
            <p className="year-run-vote">
              ...
              <span className="vote">
              <img src={require('./header/imdb_logo.png')} alt="Rating" style={{width:"40px", height:"20px",marginBottom:"-5px"}}/> {movie.vote_average}
              </span>
            </p>
          ...
          <PlayTv tmdb_id={movie.id} movie_seasons={movie.seasons} seasons_count={movie.number_of_seasons} />
          <br />
          {/* <Button
            variant="outlined"
            style={{
        ...
        <p style={{ textAlign: "center" }}><CircularProgress color="secondary"/></p>
      );
    //console.log(movie);
    return (
      <div>
        ...
        <div style={{marginLeft:"20px",marginBottom:"-50px",width:"8px",height:"40px",backgroundColor:"red"}}/> <h2 style={{marginLeft:"25px"}}>Trailer</h2>
        <br />
        ...
        <div className="lists">
        <div style={{marginLeft:"20px",marginBottom:"-50px",width:"8px",height:"40px",backgroundColor:"red"}}/><h2 style={{marginLeft:"25px"}}>Cast</h2>
          <br />
          <div
